...
def intro(request):
    return render(request,'C:/Users/Jan/PycharmProjects/Newversion/untitled/online_comp/templates/bayes/intro.html')
...
def create_and_update(request):
    ...
    return render ( request, 'C:/Users/Jan/PycharmProjects/Newversion/untitled/online_comp/templates/bayes/create_and_update.html',
            {'form': form,
...
def predict(request):
    ...
    return render ( request, 'C:/Users/Jan/PycharmProjects/Newversion/untitled/online_comp/templates/bayes/predict.html',
            {'form4':form4,
             'predictresult':predictresult,
...
def bayes_create_and_update(request):
    ...
    return render ( request, 'C:/Users/Jan/PycharmProjects/Newversion/untitled/online_comp/templates/bayes/bayes.html',
            {'form': form,
             'result': invgammaresult,
             'form3':form3,
             'form4':form4,
